...
I used SvelteKit along with Drizzle for the site, worked pretty well in my opinion. Next time I'd probably use Rails though since it just speeds up the development process a lot, though I do like the flexibility Svelte gives.
